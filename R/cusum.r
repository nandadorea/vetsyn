...
##' @aliases cusum_synd
##' @aliases cusum_synd-methods
##' @aliases cusum_synd,syndromic-method
##'
...
##'                          period=260)
##'
##'my.syndromic2 <- cusum_synd(x=my.syndromic,
##'                           syndrome= c(1,2,4,5),
##'                           evaluate.window=30,
##'                           baseline.window=260,
##'                           limit.sd=c(2.5,3,3.5),
...
setGeneric('cusum_synd',
           signature = 'x',
           function(x, ...) standardGeneric('cusum_synd'))

setMethod('cusum_synd',
